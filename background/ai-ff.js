...
async function fetchAIResponse(textForAI, context, myUsername, type = "rewrite") {
    let finalPrompt;
...
async function fetchAILotGeneration(data) {
...
async function fetchAITranslation(data) {
...
async function fetchAIImageGeneration(prompt) {
    const finalPrompt = `
