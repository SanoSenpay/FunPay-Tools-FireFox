...
function renderSalesChart(containerId) {
    ...
    browser.storage.local.get(['fpToolsSalesData', 'fpToolsSalesChartPeriod'], ({ fpToolsSalesData, fpToolsSalesChartPeriod }) => {
...
function initSalesChart() {
    ...
    [7, 14, 30, 90].forEach(days => {
        ...
        btn.addEventListener('click', () => {
            ...
            browser.storage.local.set({ fpToolsSalesChartPeriod: days });
